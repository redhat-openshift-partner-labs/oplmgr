...
func NewAWSCloudBuilderFromSecret(credsSecret *corev1.Secret) *AWSCloudBuilder {
	accessKeyID := credsSecret.Data[AWSAccessKeyIDSecretKey]
	secretAccessKey := credsSecret.Data[AWSSecretAccessKeySecretKey]
...
func (p *AWSCloudBuilder) GenerateCredentialsSecret(o *Builder) *corev1.Secret {
	return &corev1.Secret{
		...
		StringData: map[string]string{
			AWSAccessKeyIDSecretKey:     p.AccessKeyID,
			AWSSecretAccessKeySecretKey: p.SecretAccessKey,
		},
	}
}
