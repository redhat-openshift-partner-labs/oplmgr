	...
	if len(o.BoundServiceAccountSigningKey) > 0 {
		allObjects = append(allObjects, &corev1.Secret{
			...
			StringData: map[string]string{
				BoundServiceAccountSigningKeyFile: o.BoundServiceAccountSigningKey,
			},
		})
	}
...
func (o *Builder) generateSSHPrivateKeySecret() *corev1.Secret {
	return &corev1.Secret{
		...
		Type: corev1.SecretTypeOpaque,
		StringData: map[string]string{
			SSHPrivateKeySecretKey: o.SSHPrivateKey,
		},
	}
}
...
func (o *Builder) generateServingCertSecret() *corev1.Secret {
	return &corev1.Secret{
		...
		StringData: map[string]string{
			TLSCrtSecretKey: o.ServingCert,
			TLSKeySecretKey: o.ServingCertKey,
		},
	}
}
...
func (o *Builder) generateAdminKubeconfigSecret() *corev1.Secret {
	return &corev1.Secret{
		...
		Data: map[string][]byte{
			KubeconfigSecretKey:    o.AdoptAdminKubeconfig,
			RawKubeconfigSecretKey: o.AdoptAdminKubeconfig,
		},
	}
}
